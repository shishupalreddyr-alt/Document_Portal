...
class FaissManager:
    """_summary_
    """
    def __inti__(self, index_dir:Path, model_loader:Optional[ModelLoader]=None):
...
class ChatIngestor:
    ...
    def _split(self, docs: List[Document], chunk_size=400, chunk_overlap=100) -> List[Document]:
